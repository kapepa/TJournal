...
const ButtonTransparent: NextPage<IButtonTransparent> = ({text, cb}) => {
  return (
    <button className={`${style.button_transparent} flex align-items-center`} onClick={cb}>
      <svg className={style.button_transparent__svg} width={22} height={22} version="1.1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" >
        <g>
