  ...
  async getList(last: number): Promise<DtoArticle[]> {
    const list =  [
      ...
      },
      {
        ...
        title: '«Ашан» объявил о продолжении работы в России, объяснив это потребностями жителей и сохранением сотрудников',
        comments: 7,
      },{
        id: 'as4234423adasds1231asd2czxc',
        title: 'Сын Шумахера разбил болид во время квалификации «Формулы 1» и попал в больницу',
        comments: 5,
      },{
        id: 'as4234423a342ds1231asd2czxc',
        title: 'Рэпер Face заявил об удалении всей своей музыки с российских стримингов из-за ситуации на Украине',
        comments: 2,
      },{
        id: 'as4234423a342dasd31asd2czxc',
        title: 'Сообщества TJ во «ВКонтакте» и «Одноклассниках» заблокировали по решению Генпрокуратуры',
        comments: 9,
      }
    ];
